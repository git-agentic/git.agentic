...
- **The breadth of agent hooks in v1.0.** Seven agents is great when shipping multi-agent capture is the product. For us it would be scope creep dressed as parity. v1.1, design-partner-pulled, behind the framework-neutral SDK contract per [ADR-0003 Decision 3](../adr/0003-codento-executor-integration.md).
...
- Internal: [ADR-0002](../adr/0002-substrate-and-supercommit.md) (extended Commit object as platform API), [ADR-0003](../adr/0003-codento-executor-integration.md) (framework-neutral SDK contract), [ADR-0006](../adr/0006-objectstore-backend-trait.md) (ObjectStore trait), [`demo-scenario.md`](demo-scenario.md) (the discipline).
