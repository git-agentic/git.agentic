...
**Deciders:** Toni
**Supersedes:** —
**Amendments:** Decision 7 amended by [ADR-0003](0003-<partner>-executor-integration.md) — MVP framework support extended to LangGraph + Claude Agent SDK (the first platform-partner integration), via a layered/offline session-manifest path on the framework-neutral SDK contract.
