...
- [`docs/adr/0003-claude-agent-sdk-integration.md`](docs/adr/0003-claude-agent-sdk-integration.md) — first non-LangGraph integration target (the first platform-partner integration / Claude Agent SDK): real-time atomic sidecar integration per ADR-0004, with layered manifest-export only as the documented escape hatch
